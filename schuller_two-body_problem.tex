...
\directlua{
    local kerns = {
        ["NewCMMath-Book"] = {
          ...
          ["u1D6F7"] = {bottomright = { { kern = 0 } } },
          ["u1D6F9"] = {bottomright = { { kern = 0 } } },
          ["u1D464"] = {bottomright = { { kern = -90 } } },
          ["u1D437"] = {bottomright = { { kern = 0 } } },
          ["L"] = {topright = { { kern = -30 } } }
        },
        ["NewCMMath-Bold"] = {
...
% 			\draw[black, thick, ->, xshift=0.8cm, yshift=-0.8cm] (-30:0.8cm) arc (-30:-10:0.8cm);
    ...
    Thus, the usual spectral analysis for angular momentum operators using ladder operators holds, since all \(\ltworthree_n\) are finite-dimensional. Thus, using the theorems of Nelson and Peter--Weyl, and the subsequent ladder operator analysis, we get that $\overline{J_i}$'s have a pure point spectrum, and that the common eigenvectors of $\symbfit{J}^2$ and $J_3$ come as families $\psi_{j(j+1), m}$, where $m = -j, -j+1, \dots, j-1, +j$. The eigenvalue $j(j+1)$ is associated to $\symbfit{J}^2$ and $m$ is associated to $J_3$ with $j \in \symbb{N}_0/2$.
