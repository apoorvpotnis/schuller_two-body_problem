...
% 			\node[blue] at (1.4,-1.5) {$-1/r$};
    ...
    \begin{align*}
        ...
        I &\colon f \otimes g \mapsto fg \in \ltworsix,
    \end{align*}
    ...
    \(\operatorname{SU(2)}\) is a compact group. And thus, our strongly-continuous unitary representation of \(\operatorname{SU}(2)\) on \(\ltworthree\) decomposes \(\ltworthree\) into finite dimensional subspaces. \(\ltworthree_n\) denotes such a subspace. Thus,
    \[
