...
% 			\node[blue] at (1.4,-1.5) {$-1/r$};
	...
	We know that the orbital angular momentum operators are self-adjoint and defined on their Stone domains. They were defined as the generators of rotation about an axis. We shall instead consider the restrictions of the these operators on the Schwartz space to avoid running into technical issues. The Schwartz space is dense in the Stone domains and $\ltworthree$ and the operators are essentially self-adjoint on the Schwartz space. We shall now on not distinguish between the orbital angular momentum operators and their essentially self-adjoint restrictions on the Schwartz space. This machinery has been explained in the twelfth lecture `Stone's Theorem and Construction of Observables' in the English quantum mechanics series~\cite{SchullerVideos, Schuller}. It was also seen that the spectrum of these operators is contained in the integers.
