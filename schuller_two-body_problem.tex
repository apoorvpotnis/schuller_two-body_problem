...
% 			\node[blue] at (1.4,-1.5) {$-1/r$};
    ...
    Depending on \(H_\text{rel}\), a common orthonormal eigenbasis of \(\symbfit{L}\kern-1pt^2\), \(L_i\), and \(H_\text{rel}\) can possibly exist, as all three operators commute with each other pairwise. We for the moment \textit{assume} that this holds.\footnote{Clarify this later.}
