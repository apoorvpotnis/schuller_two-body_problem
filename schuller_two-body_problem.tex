...
% 			\node[blue] at (1.4,-1.5) {$-1/r$};
	...
	\end{align*}
	Substituting the above in $L_1 = -\i\hbar(y\partial_z - z\partial_y)$ and $L_2 = -\i\hbar(z\partial_x - x\partial_z)$ and calculating the partial derivatives finally gives us
	\begin{align*}
