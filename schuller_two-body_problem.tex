...
\begin{document}
    ...
    The source code, updates and corrections to this document can be found on this GitHub repository: \url{https://github.com/apoorvpotnis/schuller_two-body_problem}. The source code, along with the \texttt{.bib} file is embedded in this \textsc{PDF}. Comments and corrections can be mailed at \href{mailto:apoorvpotnis@gmail.com}{\texttt{apoorvpotnis@gmail.com}}.
...
% 			\node[blue] at (1.4,-1.5) {$-1/r$};
    ...
    Depending on \(H_\text{rel}\), a common orthonormal eigenbasis of \(\lvecsquare\), \(\tilde{L}_i\), and \(\hrel\) can possibly exist, as all three operators commute with each other pairwise. We for the moment \textit{assume} that this holds.\footnote{Clarify this later.} Thus, we have the following equations.
    \begin{align*}
